    ...
    <div className="w-full h-screen bg-gradient-to-br from-blue-50 to-green-100 p-8">
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="text-4xl font-bold text-green-600">{displayState.elapsedTime}s</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <div className="text-2xl font-bold text-gray-700 mb-6">
          {t('gameMaster.activeOrders')} ({displayState.orders.length})
        </div>
            ...
            {displayState.orders.map((order) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm text-gray-700 mb-3">{ingredientNames}</div>
                  <div
